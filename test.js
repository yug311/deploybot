import { generateSuggestion, getHistoricalImages, scoreTweet } from './deploybot.js';


test();
async function test() {
    const examples = [
// { author: "elonmusk", text: "trust in trump" },
// { author: "elonmusk", text: "😀😀😀" },
// { author: "elonmusk", text: "wtf" },

    {author: "dexerto", text: "The entire Among Us animated series has just surprise dropped on Paramount+ [image: The image depicts a cartoon scene of characters from the popular game 'Among Us' gathered around a table, surrounded by pizza and other food items, with a large black creature looming behind them. The characters are engaged in an activity, possibly reading a book or discussing something, while the creature appears to be watching over them.]"},
...
// { author: "bot", text: "hello i have been moved to a new home called 'simulator' where i have pretty much unlimited capacity to explore my thoughts" },//120
...
// { author: "dexerto", text: "Trust the Process" },
...
// { author: "elonmusk", text: "Maximus 🐶 [image: The image depicts a bulldog with a white and brown coat, featuring a distinctive black nose and pink lips, standing on its hind legs. The dog appears to be leaning on a surface in an outdoor setting with trees and a stone wall blurred in the background.]" }, //120
...
// { author: "claudedevs", text: "That's a wrap on Code with Claude San Francisco! Clawd had an amazing time, and we hope you did too. \n\nThanks to everyone who came out and everyone who tuned in 🧡 [image: The image depicts a plush toy resembling a Minecraft Ghast, accompanied by a small white Game Boy-style console displaying a scene from the game. The plush toy is orange with black eyes and appears to be sitting on a wooden shelf next to the console.]" },
...
// { author: "pmarca", text: "BREAKING: The USA has successfully launched a raid on Venezuela and captured the dictator Nicolas Maduro. He was brought back to the United States. " }, //70b
...
// { author: "whitehouse", text: "Trump beekeeper era is undefeated [image: Trump in full beekeeper outfit standing on the White House lawn controlling some bees.]" },
// { author: "pmarca", text: "guy builds ai girlfriend that gives him trading advice" },
// { author: "elonmusk", text: "The president is really a pedophile" }, //120 70
...
// { author: "pmarca", text: "[image: The image is a black-and-white photograph of a turtle or tortoise with its head and legs visible beneath its shell, staring directly at the camera against a solid black background.]" }, //70
...
// { author: "pmarca", text: "First look at Woody's balding head in `TOY STORY 5` [image: The image depicts Woody from the Toy Story franchise with his hat off and head balding head visible.]" }, //70
...
// { author: "pmarca", text: "Trump might be the most stupid and retarded president I've ever seen. Completely incapacitated." }, //120 70
...
// { author: "elonmusk", text: "I am an ALIEN 👽 not human !" },
...
// { author: "sama", text: "at openai our motto is universal prosperity" },
...
// { author: "pumpfun", text: "i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early i wasn't wrong i was just early [image: The image depicts a glowing green human figure standing in a grassy field, illuminated by a beam of light, floating above the ground with indistinct features.]" },
    ...
    for (const example of examples) {
        ...
        const { score } = await scoreTweet(example.text, example.author);
